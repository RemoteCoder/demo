...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = "DYJWPNyEs3Qdpaj1IYoLQ"
  config.twitter.secret = "X5CqhkDVDHeMFItg993It083AnEmnqnKX3oR7ANknQ"
  config.twitter.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=twitter"
  config.twitter.user_info_mapping = {:email => "screen_name"}

  config.facebook.key = "439229192851450"
  config.facebook.secret = "a7fd5a8d7e3263803828327d5916b193"
